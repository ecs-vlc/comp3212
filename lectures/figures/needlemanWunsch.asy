...
label("$F_{i,j} = \max \left\{\begin{matrix} F_{i-1,j-1} + s(a_i, b_j)\\F_{i-1,j} - 8\\F_{i,j-1} - 8\end{matrix}\right.$", (a.length-0.5, 1-b.length/3), E);
...
void aMatch(int i, string s) {
  label(s, (a.length + 0.2 + 0.3*(m-i), -b.length/3));
}
