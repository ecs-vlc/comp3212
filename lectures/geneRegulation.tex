...
\begin{PauseHighLight}
  \begin{itemize}
  \item What is a \emph{transcription factor}?
    \begin{enumerate}\setlength\itemsep{0.5em}
    \item Any biological process that affects transcription of RNA
    \item A protein that creates RNA molecules
    \item A signalling molecule that regulates transcription of RNA
    \item A protein that regulates transciption of RNA\pause
    \end{enumerate}
  \item Answer: A protein that regulates transciption of RNA\pauseb
  \end{itemize}
\end{PauseHighLight}
...
\begin{PauseHighLight}
  \begin{itemize}
  \item For the ``chemical equation''
    \begin{align*}
      X \stackrel{k}{\longrightarrow} Y
    \end{align*}
    what is the correct ODE for $X$?
    \begin{enumerate}\setlength\itemsep{0.5em}
    \item $\frac{\dd [X]}{\dd t} = k\, [Y]$
    \item $\frac{\dd [X]}{\dd t} = k\, [X]$
    \item $\frac{\dd [X]}{\dd t} = -k\, [Y]$
    \item $\frac{\dd [X]}{\dd t} = -k\, [X]$\pause
    \end{enumerate}
    \item Answer: $\frac{\dd [X]}{\dd t} = -k [X]$\pauseb
  \end{itemize}
\end{PauseHighLight}
...
\begin{PauseHighLight}
  ...
  \item For the ``chemical equation''
    \begin{align*}
      2\,X + Y \stackrel{k}{\longrightarrow} Z
    \end{align*}
    what is the correct ODE for $Z$?
    \begin{enumerate}\setlength\itemsep{0.5em}
    \item $\frac{\dd [Z]}{\dd t} = 2\,k\,[X] [Y]$
    \item $\frac{\dd [Z]}{\dd t} = 2\,k [X] + k\, [Y]$
    \item $\frac{\dd [Z]}{\dd t} = k\,[X]^2 [Y]$\pause
    \end{enumerate}
    \item Answer: $\frac{\dd [Z]}{\dd t} = k\,[X]^2 [Y]$\pauseb
  \end{itemize}
\end{PauseHighLight}
...
\begin{PauseHighLight}
  ...
  \item For the ``chemical equation''
    \begin{align*}
      4\,X + Y \stackrel{k}{\longrightarrow} 2\,X + Z
    \end{align*}
    what is the correct ODE for $X$?
    \begin{enumerate}\setlength\itemsep{0.5em}
    \item $\frac{\dd [X]}{\dd t} = -k\,[X]^4 [Y]$
    \item $\frac{\dd [X]}{\dd t} = -2\, k\,[X]^4 [Y]$
    \item $\frac{\dd [X]}{\dd t} = 4\,k [X]^4 [Y]$\pause
    \end{enumerate}
    \item Answer: $\frac{\dd [X]}{\dd t} = -2\, k\,[X]^4 [Y]$\pauseb
  \end{itemize}
\end{PauseHighLight}
